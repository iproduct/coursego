...
var GoBooks = []Book{
	{
		...
		SmallThumbnail:      parseURL("09-http://books.google.com/books/content?id=fmd-DwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"),
		Thumbnail:           parseURL("09-http://books.google.com/books/content?id=fmd-DwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"),
		Language:            "en",
		PreviewLink:         parseURL("09-http://books.google.com/books?id=fmd-DwAAQBAJ&pg=PT545&dq=golang&hl=&cd=1&source=gbs_api"),
	...
	},
	{
		...
		PrintType:           "BOOK",
		Categories:          []Category{"Computers"},
		SmallThumbnail:      parseURL("09-http://books.google.com/books/content?id=o86PDwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"),
		Thumbnail:           parseURL("09-http://books.google.com/books/content?id=o86PDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"),
		Language:            "en",
		PreviewLink:         parseURL("09-http://books.google.com/books?id=o86PDwAAQBAJ&pg=PA288&dq=golang&hl=&cd=2&source=gbs_api"),
	...
	},
	{
		...
		PrintType:           "BOOK",
		Categories:          []Category{"Computers"},
		SmallThumbnail:      parseURL("09-http://books.google.com/books/content?id=xfPEDwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"),
		Thumbnail:           parseURL("09-http://books.google.com/books/content?id=xfPEDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"),
		Language:            "en",
		PreviewLink:         parseURL("09-http://books.google.com/books?id=xfPEDwAAQBAJ&pg=PA73&dq=golang&hl=&cd=3&source=gbs_api"),
